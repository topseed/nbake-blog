...
pug_html = pug_html + "\u003Ca" + (" class=\"ui blurring fluid blue card\""+pug_attr("href", prefix+item.url+'/', true, false)) + "\u003E\u003Cdiv class=\"image\"\u003E\u003Cimg" + (pug_attr("src", prefix+item.url+'/'+item.image, true, false)) + "\u002F\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"content\"\u003E\u003Cdiv class=\"header\"\u003E" + (pug_escape(null == (pug_interp = item.title) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"meta\"\u003E" + (pug_escape(null == (pug_interp = item.created) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003Cdiv class=\"description\"\u003E" + (pug_escape(null == (pug_interp = item.content_html) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"extra content\"\u003EAuthor info here\u003C\u002Fdiv\u003E\u003C\u002Fa\u003E";
      }
  } else {
    var $$l = 0;
